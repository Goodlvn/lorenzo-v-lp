            ...
            <form action="https://world.us1.list-manage.com/subscribe/post?u=b931a098fad1826a4bfa44074&amp;id=886f33c92d" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" noValidate autoComplete="chrome-off">
                <div id="mc_embed_signup_scroll">
                    <div className="mc-field-group">
                        <input type="text" name="FNAME" className={invalidFNAME ? "error" : ""} id="mce-FNAME" placeholder="FIRST NAME" onChange={handleChange} readOnly onFocus={(e) => { console.log(e.target.removeAttribute("readonly")); }} />
                    </div>
                    <div className="mc-field-group">
                        <input type="text" name="LNAME" className={invalidLNAME ? "error" : ""} id="mce-LNAME" placeholder="LAST NAME" onChange={handleChange} readOnly onFocus={(e) => { console.log(e.target.removeAttribute("readonly")); }} />
                    </div>
                    <div className="mc-field-group">
                        <input type="phone" name="PHONE" className={invalidPHONE ? "error required phone" : "required phone"} id="mce-PHONE" placeholder="PHONE #" onChange={handleChange} readOnly onFocus={(e) => { console.log(e.target.removeAttribute("readonly")); }} />
                    </div>
                    <div className="mc-field-group">
                        <input type="email" name="EMAIL" className={invalidEMAIL ? "error required email" : "required email"} id="mce-EMAIL" placeholder="EMAIL" onChange={handleChange} readOnly onFocus={(e) => { console.log(e.target.removeAttribute("readonly")); }} />
                    </div>
